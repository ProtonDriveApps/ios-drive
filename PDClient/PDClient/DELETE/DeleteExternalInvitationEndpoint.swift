...
/// Deleting an external invitation
/// DELETE /drive/v2/shares/{shareID}/external-invitations/{invitationID}
struct DeleteExternalInvitationEndpoint: Endpoint {
    ...
    init(shareID: String, invitationID: String, service: APIService, credential: ClientCredential) {
        // url
