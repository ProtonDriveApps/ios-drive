...
struct RevisionsEndpoint: Endpoint {
    public struct Response: Codable {
        var code: Int
        var revisions: [RevisionShort]
    }
    
    var request: URLRequest
    
    init(shareID: Share.ShareID, fileID: Link.LinkID, service: APIService, credential: ClientCredential) {
        // url
