...
protocol SharedVolumesEventsControllerProtocol {
    func appendVolumeIds(_ volumeIds: [VolumeID])
    func removeVolumeIds(_ volumeIds: [VolumeID])
}

final class SharedVolumesEventsController: SharedVolumesEventsControllerProtocol {
    ...
    init(featureFlagsController: FeatureFlagsControllerProtocol, eventsManager: EventsSystemManager, volumeIdsController: SharedVolumeIdsController) {
