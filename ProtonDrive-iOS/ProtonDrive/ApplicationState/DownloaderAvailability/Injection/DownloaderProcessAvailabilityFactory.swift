...
struct DownloaderProcessAvailabilityFactory {
    func makeController(
        ...
        return ConcreteComputationalAvailabilityController(
            processId: "downloader",
            extensionController: extensionTaskController,
            processingController: ConcreteBackgroundTaskStateController(), // Downloader doesn't support BG processing mode
