...
public struct CameraCaptureTimeParser {
    public static let defaultDateFormatter = {
    ...
    public init(formatter: DateFormatter = Self.defaultDateFormatter) {
    ...
    public func parseCameraCaptureTime(fromExif exif: NSDictionary) -> (captureTime: Date?, modificationTime: Date?) {
