...
public final class LocalPhotoLibraryAuthorizationController: PhotoLibraryAuthorizationController {
    ...
    public var permissions: AnyPublisher<PhotoLibraryPermissions, Never> {
        permissionsSubject.eraseToAnyPublisher()
    }

    public init(resource: PhotoLibraryAuthorizationResource) {
