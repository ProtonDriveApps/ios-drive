...
public final class InMemoryScreenLockingBannerRepository: ScreenLockingBannerRepository {
    ...
    public var isLockBannerEnabled: AnyPublisher<Bool, Never> {
        isBannerEnabledSubject
            .removeDuplicates()
            .eraseToAnyPublisher()
    }

    public func disableLockBanner() {
