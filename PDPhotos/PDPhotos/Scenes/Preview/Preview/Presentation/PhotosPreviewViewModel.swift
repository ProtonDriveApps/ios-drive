...
final class PhotosPreviewViewModel: PhotosPreviewViewModelProtocol {
    ...
    private let actionViewModel: any PhotosPreviewActionViewModelProtocol
    var resetPreviewPublisher: AnyPublisher<PreviewDirection, Never> { controller.currentDeletedPublisher }
    ...
    init(
        ...
        coordinator: PhotosPreviewListCoordinator,
        modeController: PhotosPreviewModeController,
        detailController: PhotoPreviewCurrentDetailController,
        actionViewModel: any PhotosPreviewActionViewModelProtocol
    ) {
    ...
    func previewItemIsChanged() {
        ...
        actionViewModel.previewIsChanged(item: item)
    }
