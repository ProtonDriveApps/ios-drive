...
struct CloudNodeProvider: NodeProvider {
    typealias N = Link
    typealias Decr = CloudNodeDecryptor
    typealias ChPr = CloudChildrenProvider
    ...
    init(node: Link,
         decryptor: CloudNodeDecryptor,
         childrenProvider: CloudChildrenProvider
    ) {
        self.node = node
