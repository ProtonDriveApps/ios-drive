...
protocol RevisionCreatorOperationFactory {
    func make(from draft: FileDraft, onError: @escaping OnError) -> OperationWithProgress
}

final class DefaultRevisionCreatorOperationFactory: RevisionCreatorOperationFactory {
    ...
    func make(from draft: FileDraft, onError: @escaping OnError) -> OperationWithProgress {
        RevisionCreatorOperation(draft: draft, creator: revisionCreator, finalizer: finalizer, onError: onError)
    }
}
