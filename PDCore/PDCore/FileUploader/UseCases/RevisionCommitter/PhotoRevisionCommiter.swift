...
final class NewPhotoRevisionCommiter: NewFileRevisionCommitter {
    ...
    override func getPhotoIfNeeded(revision: Revision) throws -> CommitableRevision.Photo? {
        ...
        return CommitableRevision.Photo(mainPhotoID: photo.parent?.id, captureTime: Int(photo.captureTime.timeIntervalSince1970), exif: photoRevision.exif)
    }
