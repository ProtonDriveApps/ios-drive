...
final class StreamFileUploadOperationsProviderFactory: FileUploadOperationsProviderFactory {
    ...
    func make() -> FileUploadOperationsProvider {
        ...
        let revisionUploader = StreamRevisionUploaderOperationFactory(api: apiService, contentCreator: cloudSlot, credentialProvider: sessionVault, signersKitFactory: sessionVault)
