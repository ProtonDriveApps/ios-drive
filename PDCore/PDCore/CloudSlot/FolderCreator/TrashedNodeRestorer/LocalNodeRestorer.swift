...
public protocol LocalNodeRestorerProtocol {
    func restoreLocally(_ nodes: [NodeIdentifier]) async throws
    func restore(nodeIDs: [AnyVolumeIdentifier]) async throws
}

public final class LocalNodeRestorer: LocalNodeRestorerProtocol {
