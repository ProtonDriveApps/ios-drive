...
public enum Uploader {
    ...
    public static var osLog = OSLog.init(subsystem: "ch.protondrive.PDCore", category: "Uploader")
    private static let uploadFail: NSNotification.Name = .init("ch.protondrive.PDCore.uploadFail")
    
    public enum Errors: String, Error, LocalizedError {
    ...
    public enum Warning {
        case backgroundTaskExpired, failure(Error), success

        public var title: String {
            switch self {
            case .backgroundTaskExpired, .failure:
